...
<html lang="en">
    ...
    <body> 
								...
								<div>
									...
									<div class='text-end'>
										<input type='text' value='" .($news["id"]). "' name ='new_id' hidden>
											<button type='button' class='btn  btn-block' data-bs-toggle='modal' data-bs-target='#myModal_del'>
												<i class='fas fa-trash'></i> Xóa
											</button>
											<a href='?url=Home/Post_news/". ($news["id"]) . "'>
												<button type='button' class='btn btn-block' data-bs-toggle='modal' data-bs-target='#myModal'>
										...
										<div class='modal fade' id='myModal_del'>
											<div class='modal-dialog'>
												<div class='modal-content'>
													...
													<div class='modal-body container text-start'>Bạn có chắc chắn muốn xóa gói hàng này</div>
		...
		<script src="./Views/JS/news_detail.js"></script>
    </body>
</html>
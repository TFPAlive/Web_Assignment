...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Views\CSS\postnews.css">
    ...
    <body> 
                            ...
                            <div class="card-body">
                                <div class="content-element">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control" placeholder="Tiêu đề" value="<?php $news = $data["news"][0]; echo $news["title"]?>">
                                    </div>
                                    <div class="mt-3">
                                        <label class="" for="e-image-url"> Ảnh sản phẩm: </label>
                                        <div class="text-center">
                                            <img class="w-25 mx-auto mb-3 mt-2" src="
                                            <?php 
                                            $news = $data["news"][0]; 
                                            if($news["imgurl"]){echo $news["imgurl"];}
                                            else {echo "Views/images/default_image.png";}
                                            ?>" alt="main_img">
                                            <input type="file" id="e-image-url" name="e-image-url[]" onchange="upload_pic(this)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="form-control" rows="10" id="content" name="content">
											<?php $news = $data["news"][0]; echo $news["content"]?>
										</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-5 text-center">
                                        <div href="?url=Home/News/">
                                            <button type="submit" class="btn-sm btn btn-warning"> Hoàn tất </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="./Views/JS/Post_news.js"></script>
    </body>
</html>